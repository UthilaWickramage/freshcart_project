        ...
        <div class="row mb-8">
          <div class="col-md-12">
            ...
            <div class="card bg-light border-0 rounded-4"
                 style="background-image: url(${BASE_URL}assets/images/slider/slider-image-1.jpg); background-repeat: no-repeat; background-size: cover; background-position: right;">
                ...
                <div class="mt-4">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="mb-2">
                      ...
                      <span class="ms-1"><span class="text-dark">Shippings
