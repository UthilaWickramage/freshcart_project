                ...
                <div class="table-responsive">
                  <table
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-2.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-3.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-4.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-5.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-6.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                            <a href="#" class="text-inherit">John Mattox</a>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-7.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                            <a href="#" class="text-inherit">Wayne Rossman</a>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-8.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-9.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-10.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
                            <a href="#" class="text-inherit">Stephanie Morales</a>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="${BASE_URL}assets/images/avatar/avatar-11.jpg" alt=""
                               class="avatar avatar-xs rounded-circle">
                          <div class="ms-2">
