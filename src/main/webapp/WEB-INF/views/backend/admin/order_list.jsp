                ...
                <div class="table-responsive">
                  <table class="table table-centered table-hover text-nowrap table-borderless mb-0 table-with-checkbox">
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1007</a></td>
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1006</a></td>
                      <td>Willie Hanson</td>
                      <td>E-Grocery Super Market</td>
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1005</a></td>
                      <td>Dori Stewart </td>
                      <td>E-Grocery Super Market</td>
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1004</a></td>
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1003</a></td>
                      <td>Maria Roux </td>
                      <td>E-Grocery Super Market</td>
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1002</a></td>
                      <td>Robert Donald</td>
                      <td>E-Grocery Super Market</td>
                    ...
                    <tr>
                      ...
                      <td><a href="${BASE_URL}admin_order" class="text-reset">FC#1001</a></td>
                      <td>Diann Watson</td>
                      <td>E-Grocery Super Market</td>
