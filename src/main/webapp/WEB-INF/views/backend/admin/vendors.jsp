        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-2.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-3.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-4.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-5.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-6.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-7.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-8.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
          ...
          <div class="col">
            ...
            <div class="card border-0 text-center card-lg">
              <div class="card-body p-6">
                <div>
                  <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-9.svg" alt=""
                                   class="rounded-circle icon-shape icon-xxl mb-6">
                  <!-- content -->
