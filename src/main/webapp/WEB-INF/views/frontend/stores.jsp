            ...
            <div class="col-12 ">
              ...
              <div class="bg-light d-flex justify-content-between ps-md-10 ps-6 rounded">
                ...
                <div class="py-6">
                  <!-- img -->
                  <!-- img -->
                  <img src="${BASE_URL}assets/images/svg-graphics/store-graphics.svg" alt="" class="img-fluid"></div>
              </div>
        ...
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-lg-4 row-cols-md-3 g-4 g-lg-4">
            ...
            <div class="col">
              ...
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-1.svg" alt=""
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-2.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-3.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-4.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-5.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-6.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-7.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-8.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
            ...
            <div class="col">
              <!-- card --><div class="card p-6 card-product">
              <div> <!-- img --><img src="${BASE_URL}assets/images/stores-logo/stores-logo-9.svg" alt=""
                                     class="rounded-circle icon-shape icon-xl"></div>
              <div class="mt-4">
