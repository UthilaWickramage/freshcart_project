...
<layout:extends name="base">
    <layout:put block="content">
        <main>
            <c:set var="items" value="${it[0]}" scope="page"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="product mt-5" id="product">
                                <c:forEach items="${items.images[0]}" var="s" end="0">
                                    <div class="d-flex justify-content-center align-items-center border border-black border-1 overflow-hidden">

                                        <!-- img -->

                                        <!-- img --><img id="bigImage" style="transform: scale(1.1); overflow: hidden"
                                                         src="${BASE_URL}${s}" height="400px"
                                                         alt="">
                            ...
                            <div class="product-tools">
                                <div class="thumbnails row gx-3 " id="productThumbnails">
                                    ...
                                    <c:forEach items="${items.images}" var="image" begin="1" end="4">

                                        <div class="col-3 d-flex align-items-center " style="min-height: 100px">
                                            <div class="thumbnails-img ">
                                                <!-- img -->
                                                <img src="${BASE_URL}${image}" onclick="view(this.src,this)"
                                                     class="border border-black border-1" alt="">
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="ps-lg-10 mt-6 mt-md-0">
                                ...
                                <div class="fs-4">
                                    <!-- price --><span
                                        class="fw-bold text-dark">Sale Price: Rs ${items.sale_price}0</span><br>
                                ...
                                <div class="mb-5"><span
                                    ...
                                    <div>
                                        ...
                                        <table class="table table-borderless mb-0">
                                            ...
                                            <tr>
                                                <td>Type:</td>
                                                <td>${items.categoryId.name}</td>

                                            </tr>
                                            <tr>
                                                <td>Shipping:</td>
                                                <td><small>01 day shipping.<span
                                                        class="text-muted">( Free pickup today)</span></small>
                                                </td>
    ...
    <layout:put block="script">
        <script>
            ...
            function view(src, element) {
                element.src = document.getElementById('bigImage').src
