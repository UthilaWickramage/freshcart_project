                      ...
                      <div class="col-md-8">
                        <div class="mb-10">
                          ...
                          <div class="d-flex border-bottom pb-6 mb-6">
                            <!-- img -->
                            <!-- img --><img src="${BASE_URL}assets/images/avatar/avatar-10.jpg" alt=""
                            ...
                            <div class="ms-5">
                              ...
                              <div>
                                <div class="border icon-shape icon-lg border-2 ">
                                  <!-- img --><img src="${BASE_URL}assets/images/products/product-img-1.jpg" alt=""
                                                   class="img-fluid ">
                                </div>
                                <div class="border icon-shape icon-lg border-2 ms-1 ">
                                  <!-- img --><img src="${BASE_URL}assets/images/products/product-img-2.jpg" alt=""
                                                   class="img-fluid ">
                                </div>
                                <div class="border icon-shape icon-lg border-2 ms-1 ">
                                  <!-- img --><img src="${BASE_URL}assets/images/products/product-img-3.jpg" alt=""
                                                   class="img-fluid ">
                                </div>
                          ...
                          <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                            <!-- img --><img src="${BASE_URL}assets/images/avatar/avatar-12.jpg" alt=""
                                             class="rounded-circle avatar-lg">
                            <div class="ms-5">
                              <h6 class="mb-1">
                                Robert Thomas
                          ...
                          <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                            <!-- img --><img src="${BASE_URL}assets/images/avatar/avatar-9.jpg" alt=""
                                             class="rounded-circle avatar-lg">
                            <div class="ms-5">
                              <h6 class="mb-1">
                                Barbara Tay
                          ...
                          <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                            <!-- img --><img src="${BASE_URL}assets/images/avatar/avatar-8.jpg" alt=""
                                             class="rounded-circle avatar-lg">
              ...
              <div class="card card-product">
                <div class="card-body">
                  ...
                  <div class="text-center position-relative ">
                    ...
                    <a href="#!">
                      <!-- img --><img src="${BASE_URL}assets/images/products/product-img-1.jpg" alt="Grocery Ecommerce Template"
              ...
              <div class="card card-product">
                <div class="card-body">
                  ...
                  <div class="text-center position-relative"> <a href="#!"><img
                          src="${BASE_URL}assets/images/products/product-img-2.jpg" alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
            ...
            <div class="col">
              <div class="card card-product">
                <div class="card-body">
                  <!-- badge -->
                  <div class="text-center position-relative"> <a href="#!"><img
                          src="${BASE_URL}assets/images/products/product-img-3.jpg" alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
            ...
            <div class="col">
              <div class="card card-product">
                <div class="card-body">
                  <!-- badge -->
                  <div class="text-center position-relative"> <a href="#!"><img
                          src="${BASE_URL}assets/images/products/product-img-4.jpg" alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
            ...
            <div class="col">
              <div class="card card-product">
                <div class="card-body">
                  <!-- badge -->
                  <div class="text-center position-relative"> <a href="#!"><img
                          src="${BASE_URL}assets/images/products/product-img-9.jpg" alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
