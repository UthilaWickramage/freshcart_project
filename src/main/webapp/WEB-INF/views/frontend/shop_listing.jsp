        ...
        <div class="container">
          ...
          <div class="row gx-10">
            ...
            <section class="col-lg-9 col-md-12">
              <c:set var="category" scope="page" value="${it[1]}"/>
              <!-- card -->
              ...
              <div class="row g-4 row-cols-xl-4 row-cols-lg-3 row-cols-2 row-cols-md-2 mt-2">
                ...
                <c:forEach var="product" items="${it[0]}">
                  <!-- col -->
                  <div class="col">
                    <!-- card -->
                      ...
                      <div class="card-body">
                        ...
                        <c:forEach items="${product.images}" var="image" end="0">
                          <a href="${BASE_URL}${product.id}">
                            <!-- img --><img src="${BASE_URL}${image}"
                                             alt="Grocery Ecommerce Template" style="height: 200px; overflow: hidden" class="mb-3 img-fluid"></a>
                        </c:forEach>
                          <!-- action btn -->
                        ...
                        <!-- heading -->
                        <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>${category.name}</small></a></div>
