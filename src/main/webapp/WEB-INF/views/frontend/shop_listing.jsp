              ...
              <div class="offcanvas offcanvas-start offcanvas-collapse w-md-50 " tabindex="-1" id="offcanvasCategory" aria-labelledby="offcanvasCategoryLabel">
                ...
                <div class="offcanvas-body ps-lg-2 pt-lg-0">
                  ...
                  <div class="mb-8 position-relative">
                    ...
                    <!-- Banner Content -->
                    <!-- Banner Image -->
                    <!-- img --><img src="${BASE_URL}assets/images/banner/assortment-citrus-fruits.png" alt=""
                    ...
                    <div class="card-body">
                      ...
                      <div class="text-center position-relative ">
                        ...
                        <a href="shop-single.html">
                          <!-- img --><img src="${BASE_URL}assets/images/products/product-img-1.jpg"
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      ...
                      <div class="text-center position-relative">
                        ...
                        <a href="shop-single.html">
                          <!-- img --><img src="${BASE_URL}assets/images/products/product-img-2.jpg"
                                           alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                          <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      ...
                      <div class="text-center position-relative">
                        ...
                        <a href="shop-single.html">
                          <!-- img --><img src="${BASE_URL}assets/images/products/product-img-4.jpg"
                                           alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                          <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                ...
                <div class="col">
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <!-- badge -->
                      <div class="text-center position-relative"> <a href="shop-single.html"><img
                              src="${BASE_URL}assets/images/products/product-img-5.jpg" alt="Grocery Ecommerce Template"
                              class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                          <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      ...
                      <div class="text-center position-relative ">
                        ...
                        <a href="shop-single.html">
                          <!-- img --><img src="${BASE_URL}assets/images/products/product-img-6.jpg"
                                           alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                          <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                ...
                <div class="col">
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <!-- badge -->
                      <div class="text-center position-relative"> <a href="shop-single.html"><img
                              src="${BASE_URL}assets/images/products/product-img-7.jpg" alt="Grocery Ecommerce Template"
                              class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                          <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                ...
                <div class="col">
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <!-- badge -->
                      <div class="text-center position-relative"> <a href="shop-single.html"><img
                              src="${BASE_URL}assets/images/products/product-img-8.jpg" alt="Grocery Ecommerce Template"
                              class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                          <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                ...
                <div class="col">
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <!-- badge -->
                      <div class="text-center position-relative"> <a href="shop-single.html"><img
                              src="${BASE_URL}assets/images/products/product-img-10.jpg" alt="Grocery Ecommerce Template"
                              class="mb-3 img-fluid"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
