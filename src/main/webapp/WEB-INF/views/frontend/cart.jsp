                    ...
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="py-3">
                            ...
                            <div class="alert alert-primary p-2" role="alert">
                                You have successfully added an item to the Cart<a href="#!" class="alert-link">checkout now!</a>
                            </div>
                            <ul class="list-group list-group-flush">
                                <!-- list group -->
                               <c:forEach items="${it.productId}" var="items">
                                   <li class="list-group-item py-3 py-lg-0 px-0 border-top">
                                       <!-- row -->
                                       <div class="row align-items-center">
                                           <div class="col-3 col-md-2">
<%--                                               <!-- img --> <c:forEach items="${items.productImage}" var="i">--%>
<%--                                               <img src="${BASE_URL}${i.url}" alt="Ecommerce"--%>
<%--                                                    class="img-fluid"></div>--%>
<%--                                           </c:forEach>--%>
                                           <div class="col-4 col-md-5">
                                               <!-- title -->
                                               <a href="shop-single.html" class="text-inherit"><h6 class="mb-0">${items.title}<small>(${items.brand})</small></h6></a>
                                               <span><small class="text-muted">${items.weight} ${items.unit}</small></span>
                                               <!-- text -->
