                                ...
                                <li class="list-group-item py-3 py-lg-0 px-0 border-top">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-3 col-md-2">
                                            <!-- img --> <img src="${BASE_URL}assets/images/products/product-img-1.jpg" alt="Ecommerce"
                                                              class="img-fluid"></div>
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                            ...
                            <line x1="14" y1="11" x2="14" y2="17"></line>
                                ...
                                <li class="list-group-item py-3 py-lg-0 px-0">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-3 col-md-2">
                                            <!-- img --> <img src="${BASE_URL}assets/images/products/product-img-2.jpg" alt="Ecommerce"
                                                              class="img-fluid"></div>
                                        <div class="col-4 col-md-5">
                                            <!-- title -->
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                            ...
                            <line x1="14" y1="11" x2="14" y2="17"></line>
                                ...
                                <li class="list-group-item py-3 py-lg-0 px-0">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-3 col-md-2">
                                            <!-- img --> <img src="${BASE_URL}assets/images/products/product-img-3.jpg" alt="Ecommerce"
                                                              class="img-fluid"></div>
                                        <div class="col-4 col-md-5">
                                            <!-- title -->
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                            ...
                            <line x1="14" y1="11" x2="14" y2="17"></line>
                                ...
                                <li class="list-group-item py-3 py-lg-0 px-0">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-3 col-md-2">
                                            <!-- img --> <img src="${BASE_URL}assets/images/products/product-img-4.jpg" alt="Ecommerce"
                                                              class="img-fluid"></div>
                                        <div class="col-4 col-md-5">
                                            <!-- title -->
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                            ...
                            <line x1="14" y1="11" x2="14" y2="17"></line>
                                ...
                                <li class="list-group-item py-3 py-lg-0 px-0 border-bottom">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-3 col-md-2">
                                            <!-- img --> <img src="${BASE_URL}assets/images/products/product-img-5.jpg" alt="Ecommerce"
                                                              class="img-fluid"></div>
                                        <div class="col-4 col-md-5">
                                            <!-- title -->
