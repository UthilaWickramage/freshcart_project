            ...
            <div class="col-12 col-lg-3 col-md-4 mb-4 mb-md-0">
              <div class="d-flex flex-column">
                <div>
                  ...
                  <!-- img -->
                  <img
                          src="${BASE_URL}assets/images/stores-logo/stores-logo-1.svg"
                          alt=""
            ...
            <div class="col-12 col-lg-9 col-md-8">
              ...
              >
                ...
                <div class="py-4">
                  <!-- img -->
                  <img
                          src="${BASE_URL}assets/images/svg-graphics/store-graphics.svg"
                          alt=""
                          class="img-fluid"
                  />
                </div>
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-1.jpg"
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-2.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-3.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-4.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-5.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-6.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-7.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-8.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-9.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
                  ...
                  <div class="card card-product">
                    <div class="card-body">
                      <div class="text-center position-relative">
                        ...
                        <a href="#!">
                          <!-- img --><img
                                src="${BASE_URL}assets/images/products/product-img-10.jpg"
                                alt="Grocery Ecommerce Template"
                                class="mb-3 img-fluid"
                        /></a>
                        <!-- btn action -->
