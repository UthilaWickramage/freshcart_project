                ...
                <div class="table-responsive">
                  <table class="table text-nowrap table-with-checkbox">
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="#"><img src="${BASE_URL}assets/images/products/product-img-18.jpg"
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="#"><img src="${BASE_URL}assets/images/products/product-img-17.jpg"
                                         class="icon-shape icon-xxl" alt=""></a>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="#"><img src="${BASE_URL}assets/images/products/product-img-16.jpg"
                                         class="icon-shape icon-xxl" alt=""></a>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="#"><img src="${BASE_URL}assets/images/products/product-img-19.jpg"
                                         class="icon-shape icon-xxl" alt=""></a>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="#"><img src="${BASE_URL}assets/images/products/product-img-15.jpg"
                                         class="icon-shape icon-xxl" alt=""></a>
