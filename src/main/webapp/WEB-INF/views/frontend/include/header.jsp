    ...
    <div class="container">
        ...
        <div class="row align-items-center pt-6 pb-4 mt-4 mt-lg-0">
            <div class="col-xl-2 col-md-3 mb-4 mb-md-0 col-12 text-center text-md-start">
                <a href="${BASE_URL}home"><img src="${BASE_URL}assets/images/logo/freshcart-logo.svg"
                    ...
                    <c:choose>
                        ...
                        <div class="d-flex align-items-center justify-content-end ms-4">
                            <div class="ms-6 text-center">
                                <a href="${BASE_URL}admin/dashboard" class="text-reset">
                                    <div class="lh-1">
                                        <div class="mb-2">
                                            <i class="bi bi-person-circle fs-4"></i>

                                        </div>
                                        <p class="mb-0 d-none d-xl-block small">Admin Dashboard</p>
                                    </div>
                                </a>
                            </div>
                            <div class="ms-6 text-center">
                        ...
                        <c:otherwise>
                            <c:choose>
                                <c:when test="${vendor ne null}">
                        <div class="d-flex align-items-end justify-content-around ms-4">
                                    <div class="ms-6 text-center">
                                        <a href="${BASE_URL}vendor/dashboard" class="text-reset">
                                            <div class="lh-1">
                                                <div class="mb-2">
                                                    <i class="bi bi-person-circle fs-4"></i>

                                                </div>
                                                <p class="mb-0 d-none d-xl-block small">Vendor Dashboard</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="ms-6 text-center">
                                                ...
                                                <a href="${BASE_URL}cart"
                                                   ...
                                                   class="text-reset">
                                                    <div class="text-center">
                                                        ...
                                                        <a href="${BASE_URL}cart" class="mb-0 d-none d-xl-block small text-dark-info">Shopping
                                                            Cart</a>
                                                    </div>
                                                </a>
                                            </div>
                                                ...
                                                <a href="${BASE_URL}cart"
                                                   ...
                                                   class="text-reset">
                                                    <div class="text-center">
                                                        ...
                                                        <a href="${BASE_URL}signin" class="mb-0 d-none d-xl-block small text-dark-info">Sign In</a>
                                                    </div>
                                                </a>
                                            </div>
                        </div>
                                    ...
                                    <div class="dropdown-menu-list-submenu">
                                        <div>
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item">Water &amp; Ice
                                                        Cubes</a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="dropdown-menu-list-submenu ">
                                        <div>
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item">Frozen Non-Veg
                                                        Snacks</a>
                                                </li>
                                    ...
                                    <div class="dropdown-menu-list-submenu">
                                        <div>
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item">Bath &amp; Hair
                                                        Care
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item">Oral &amp; Nasal
                                                        Care
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item">Baby Skin Care
                                                        Online</a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item">Cleaning Needs
                                                        Online</a>
                                                </li>
                                                <li>
                                ...
                                <div class="row p-2 p-lg-4">
                                    ...
                                    <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                        <div class="card border-0">
                                            <img src="${BASE_URL}assets/images/banner/menu-banner.jpg"
