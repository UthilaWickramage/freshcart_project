                            ...
                            <div class="col-lg-7 col-md-12">
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <div class="accordion-item py-4">
                                        <c:set var="user" value="${it[0]}" scope="page"/>
                                                    ...
                                                    <div class="col-lg-6 col-12 mb-4">
                                                        ...
                                                        <div class="card card-body p-6 ">
                                                            ...
                                                            <address>
                                                                ...
                                                                <abbr title="Phone">P: ${user.mobile}</abbr></address>
                                            ...
                                            <ul class="nav nav-pills nav-pills-light mb-3 nav-fill mt-5" id="pills-tab"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    ...
                                                    <button class="nav-link" id="pills-Tue-tab" data-bs-toggle="pill"
                                                            ...
                                                            aria-selected="false">Tue <br><small>Oct
                                                        5</small></button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <!-- button -->
                                                    <button class="nav-link" id="pills-Wed-tab" data-bs-toggle="pill"
                                                            ...
                                                            aria-selected="false">Wed <br><small>Oct
                                                        6</small></button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <!-- button -->
                                                    <button class="nav-link" id="pills-Thu-tab" data-bs-toggle="pill"
                                                            ...
                                                            aria-selected="false">Thu <br> <small>Oct
                                                        7</small></button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <!-- button -->
                                                    <button class="nav-link" id="pills-Fri-tab" data-bs-toggle="pill"
                                                            ...
                                                            aria-selected="false">Fri <br> <small>Oct
                                                        8</small></button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <!-- button -->
                                                    <button class="nav-link" id="pills-Sat-tab" data-bs-toggle="pill"
                                                            ...
                                                            aria-selected="false">Sat <br> <small>Oct
                                                        9</small>
                                                    </button>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="mt-5">
                                                <div>
                                                            ...
                                                            <div class="d-flex mb-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="mb-0 small">Safe money transfer using your
                                                                        ...
                                                                        Mastercard tercard, Visa, Discover and
                                                                        Stripe.</p>
                                                                </div>
                                                            </div>
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-md-3 col-6">
                                                                    ...
                                                                    <div class="mb-3  mb-lg-0 position-relative">
                                                                        ...
                                                                        <input class="form-control flatpickr " id="month"
                                                                ...
                                                                <div class="col-md-3 col-6">
                                                                    ...
                                                                    <div class="mb-3  mb-lg-0 position-relative">
                                                                        ...
                                                                        <input class="form-control flatpickr " id="year"
                                                                               type="text" placeholder="Select Date">
                                                                        <div class="position-absolute bottom-0 end-0 p-3 lh-1">
                                                                            <i class="bi bi-calendar text-muted"></i>
                                                                        </div>
                                                    ...
                                                    <div class="mt-5 d-flex justify-content-end">
                                                        ...
                                                        <a href="#" class="btn btn-primary ms-2" id="order-btn">Place Order</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-4 mt-lg-0">
                                    <div class="card shadow-sm">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <!-- list group item -->
                                           <c:forEach var="item" items="${it[1].list}">
                                               <li class="list-group-item px-4 py-3">
                                                   <div class="row align-items-center">
                                                       <div class="col-2 col-md-2">
                                                           <c:forEach var="img" items="${item.productId.images}" end="0">
                                                               <img src="${BASE_URL}${img}"
                                                                    alt="Ecommerce" class="img-fluid">
                                                           </c:forEach>
                                                           </div>
                                                       <div class="col-5 col-md-5">
                                                           <h6 class="mb-0">${item.productId.title}</h6>
                                                           <span><small class="text-muted">${item.productId.weight} / ${item.productId.unit}</small></span>
                                                       ...
                                                       <div class="col-3 text-lg-end text-start text-md-end col-md-4">
                                                           <span class="fw-bold">Rs ${item.productId.sale_price + item.productId.shipping_price}0</span>
                                            ...
                                            <li class="list-group-item px-4 py-3">
                                                <div class="d-flex align-items-center justify-content-between fw-bold">
                                                    ...
                                                    <div>
                                                        Rs ${it[1].total}0
<input hidden="true" id="total" value="${it[1].total}">
    ...
    <layout:put block="script">
        ...
        <script>
            ...
            document.getElementById("order-btn").addEventListener('click',(e)=>{
                e.preventDefault();
                secureFetch('${BASE_URL}api/checkout',{
                    method:'post',
                }).then(async resp => {
...
//             let stripe = Stripe(
//                 "pk_test_51O0po3ACrOI8B7KAd6R6dFosbA2W1wdSpVhRnDjDPa5GSfLizowGBCcmnxU4yjFDER2Mqh19ToIGNOy48Rjnl3nr00jEve8Yi0"
//             )
//             document.getElementById('order-btn').addEventListener('click',(evt)=>{
...
//     lineItems:[
//         {
//             price:"price_1O0qVfACrOI8B7KAtqiY4h0S",
//             quantity:1,
//
//         }
//
