...
public class ResetPasswordEmail extends Mailable{
    private String to;
    private String verification_code;
    private String name;

    public ResetPasswordEmail(String to,String name,String verification_code){
        this.to = to;
    ...
    public void build(Message message) throws MessagingException {
        ...
        String verifyUrl = appUrl+"/verify/verify-email?token="+verification_code;
        ...
        HtmlTextEmail htmlTextEmail = getEmailTemplateConfigBuilder()
                ...
                .text("TO reset password click on the button below").center().and()
